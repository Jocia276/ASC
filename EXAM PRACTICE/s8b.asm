;8. Se da un sir de dublucuvinte. Sa se obtina sirul format din octetii superiori ai cuvintelor inferioare din elementele sirului de dublucuvinte, 
...
s dd 1A2BDC4Dh, 1E983C76h, 12341478h 
ls equ($-s)/4
d db ls dup(?)
